namespace Transbank.Tests.E2E
{
    ...
    {
        internal static readonly string MultiCodeSaleDebitVoucher =
            "               TRANSBANK                " +
        ...
        internal static readonly string MultiCodeSaleCreditVoucher =
            "               TRANSBANK                " +
            ...
            "IVA:                              $1.916" +
            "TOTAL:                           $12.000" +
            "3 CUOTAS SIN INTERES TASA:0,00%         " +
            "MONTO CUOTA:                      $4.000" +
            "MONEDA:                             PESO" +
